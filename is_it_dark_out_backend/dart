...
class IsItDarkOutBackendImpl implements IsItDarkOutBackend {
  final IsItDarkOutBackendPlatform _platform;
  factory IsItDarkOutBackendImpl(ExternalLibrary dylib) =>
      IsItDarkOutBackendImpl.raw(IsItDarkOutBackendPlatform(dylib));
...
class IsItDarkOutBackendPlatform
    extends FlutterRustBridgeBase<IsItDarkOutBackendWire> {
  IsItDarkOutBackendPlatform(ffi.DynamicLibrary dylib)
      : super(IsItDarkOutBackendWire(dylib));
...
class IsItDarkOutBackendWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  IsItDarkOutBackendWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  IsItDarkOutBackendWire.fromLookup(
